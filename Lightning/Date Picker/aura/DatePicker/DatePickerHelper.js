({
  ...
  goToToday: function(component, event) {
    ...
    this.setDateValues(component, targetDate, currentDay);
    var dateFormat=component.get("v.formatSpecifier");
    var dateStr=$A.localizationService.formatDate(targetDate,dateFormat);
    
    component.set("v.selectedDate", targetDate);
  ...
  setDateValues: function(component, fullDate, dateNum) {
    ...
    //String dateFormat=component.get("v.formatSpecifier");
    //String dateStr=$A.localizationService.formatDate(fullDate,'dd/M/Y');
    //component.set("v.value", dateStr);
  },
